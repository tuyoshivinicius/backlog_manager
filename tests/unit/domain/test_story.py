...
class TestStory:
    ...
    def test_create_valid_story(self) -> None:
        ...
        story = Story(
            id="S1", feature="Autenticação", name="Implementar login", story_point=StoryPoint(5), priority=1
        )
    ...
    def test_reject_empty_id(self) -> None:
        ...
        with pytest.raises(ValueError, match="ID da história não pode ser vazio"):
            Story(id="", feature="Test", name="Test", story_point=StoryPoint(5))

    def test_reject_empty_feature(self) -> None:
        """Deve rejeitar feature vazia."""
        with pytest.raises(ValueError, match="Feature não pode ser vazia"):
            Story(id="S1", feature="", name="Test", story_point=StoryPoint(5))
    ...
    def test_reject_empty_name(self) -> None:
        ...
        with pytest.raises(ValueError, match="Nome da história não pode ser vazio"):
            Story(id="S1", feature="Test", name="", story_point=StoryPoint(5))
    ...
    def test_reject_negative_priority(self) -> None:
        ...
        with pytest.raises(ValueError, match="Prioridade não pode ser negativa"):
            Story(id="S1", feature="Test", name="Test", story_point=StoryPoint(5), priority=-1)
    ...
    def test_reject_negative_duration(self) -> None:
        ...
        with pytest.raises(ValueError, match="Duração não pode ser negativa"):
            Story(id="S1", feature="Test", name="Test", story_point=StoryPoint(5), duration=-1)
    ...
    def test_reject_self_dependency_in_init(self) -> None:
        ...
        with pytest.raises(ValueError, match="não pode depender de si mesma"):
            Story(id="S1", feature="Test", name="Test", story_point=StoryPoint(5), dependencies=["S1"])
    ...
    def test_deallocate_developer(self) -> None:
        ...
        story = Story(id="S1", feature="Test", name="Test", story_point=StoryPoint(5), developer_id="DEV1")
    ...
    def test_story_equality_by_id(self) -> None:
        ...
        story1 = Story(id="S1", feature="Feature1", name="Name1", story_point=StoryPoint(5))
        story2 = Story(id="S1", feature="Feature2", name="Name2", story_point=StoryPoint(8))
        story3 = Story(id="S2", feature="Feature1", name="Name1", story_point=StoryPoint(5))
    ...
    def test_story_hashable(self) -> None:
        ...
        story1 = Story(id="S1", feature="Test", name="Test", story_point=StoryPoint(5))
        story2 = Story(id="S1", feature="Test2", name="Test2", story_point=StoryPoint(8))
        story3 = Story(id="S2", feature="Test", name="Test", story_point=StoryPoint(5))
