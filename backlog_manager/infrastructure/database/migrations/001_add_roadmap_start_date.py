"""Migration 001: Adiciona coluna roadmap_start_date à tabela configuration."""
import sqlite3


def upgrade(connection: sqlite3.Connection) -> bool:
    """
    Aplica a migration adicionando a coluna roadmap_start_date.
...
def downgrade(connection: sqlite3.Connection) -> None:
    """
    Reverte a migration removendo a coluna roadmap_start_date.
